...
fun Panel.paddingHorizontal(cols: Int = 1): Panel = paddingStart(cols).paddingEnd(cols)

fun Panel.paddingVertical(rows: Int = 1): Panel = paddingTop(rows).paddingBottom(rows)

fun Panel.padding(size: Int = 1): Panel = paddingHorizontal(size).paddingVertical(size)

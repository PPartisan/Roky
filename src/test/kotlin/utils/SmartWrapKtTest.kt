...
//        "  ciao ciao".smartWrap(6).shouldBeEqual("  ciao${lineSeparator()}ciao")
//    }
//
//    @Test
//    fun `when character at index = maxCharsPerLine is endOfLine, is retains the endOfLine`() {
//        "ciaoo\nmaka".smartWrap(6).shouldBeEqual("ciaoo${lineSeparator()}maka")
//    }
//
//    @Test
//    fun `when string has two end of line characters in a row, return string should retain them`() {
//        "ciaoo\n\nmaka".smartWrap(6).shouldBeEqual("ciaoo${lineSeparator()}${lineSeparator()}maka")
//    }
